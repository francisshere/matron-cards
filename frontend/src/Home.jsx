        ...
        <div className="w-full max-w-3xl flex flex-col">
          ...
          <div className="mb-8">
            <div className="flex flex-col lg:flex-row items-center lg:items-start relative">
              ...
              <div
                className="flex-1 w-full perspective-1000 cursor-pointer min-h-[180px] group"
              ...
              >
                <div className={`relative w-full h-full transition-transform duration-700 transform-style-3d ${showRationale ? 'rotate-x-180' : ''}`}>
                  ...
                  {/* Front */}
                  <div className="relative z-20 w-full h-full border-[3px] border-[#4A1529] bg-white rounded-2xl shadow-[0px_4px_0px_0px_#4A1529] flex flex-col overflow-hidden backface-hidden transition-all duration-300 active:translate-y-1 active:shadow-none min-h-[180px] group-hover:-translate-y-2 group-hover:shadow-[0px_8px_0px_0px_#4A1529]">
                  ...
                  {/* Back */}
                  <div className="absolute z-10 inset-0 w-full h-full border-[3px] border-[#4A1529] bg-white rounded-2xl shadow-[0px_-4px_0px_0px_#4A1529] flex flex-col overflow-hidden backface-hidden rotate-x-180 transition-all duration-300 active:-translate-y-1 active:shadow-none group-hover:translate-y-2 group-hover:shadow-[0px_-8px_0px_0px_#4A1529]">
