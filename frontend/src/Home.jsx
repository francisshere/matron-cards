...
export default function Home({ onStartQuiz }) {
  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col lg:flex-row text-text font-body">
      ...
      {/* Sidebar Navigation */}
      <aside className="hidden lg:flex w-[450px] fixed left-0 top-0 h-full bg-bg border-r-[4px] border-muted flex-col p-6 z-20">
        ...
        <nav className="flex flex-col space-y-4 flex-1 w-full items-center">
          {/* Active Item */}
          <a href="#" className="flex items-center w-[400px] py-4 px-6 rounded-2xl border-[3px] border-primary bg-primary/10 text-primary transition-colors group">
          ...
          {/* Inactive Item */}
          <a href="#" className="flex items-center w-[400px] py-4 px-6 rounded-2xl border-[3px] border-transparent hover:border-muted hover:bg-primary/5 text-muted transition-colors group">
            <div className="w-16 h-16 mr-4 flex items-center justify-center shrink-0">
      ...
      {/* Main Content Area */}
      <main className="w-full lg:w-[calc(100%-450px)] lg:ml-[450px] p-6 sm:p-12 flex justify-center">
